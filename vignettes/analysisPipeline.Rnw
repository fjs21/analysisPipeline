...
\begin{figure}
\centering
\makebox[0in]{\includegraphics[width=7in]{BioCarta_GSEA.pdf}}
...
\begin{figure}
\centering
<<bioCartaPathway, fig = true, echo = false>>=
i = 1
...
\begin{figure}
\centering
<<bioCartaHeatmap, fig = true, echo = false>>=
